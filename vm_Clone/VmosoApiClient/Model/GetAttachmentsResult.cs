...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetAttachmentsResult :  IEquatable<GetAttachmentsResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAttachmentsResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAttachmentsResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAttachmentsResult" /> class.
        /// </summary>
        ...
        public List<DocumentV2Record> Attachments { get; set; }
        /// <summary>
        /// Gets or Sets Pager
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAttachmentsResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetAttachmentsResult);
        }

        /// <summary>
        /// Returns true if GetAttachmentsResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetAttachmentsResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAttachmentsResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
