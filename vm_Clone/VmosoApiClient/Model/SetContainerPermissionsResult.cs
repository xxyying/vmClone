...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SetContainerPermissionsResult :  IEquatable<SetContainerPermissionsResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetContainerPermissionsResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SetContainerPermissionsResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SetContainerPermissionsResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetContainerPermissionsResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SetContainerPermissionsResult);
        }

        /// <summary>
        /// Returns true if SetContainerPermissionsResult instances are equal
        /// </summary>
        /// <param name="other">Instance of SetContainerPermissionsResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetContainerPermissionsResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
