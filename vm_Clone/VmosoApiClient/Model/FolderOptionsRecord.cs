...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FolderOptionsRecord : StreamOptionsRecord,  IEquatable<FolderOptionsRecord>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderOptionsRecord" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FolderOptionsRecord {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FolderOptionsRecord);
        }

        /// <summary>
        /// Returns true if FolderOptionsRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of FolderOptionsRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FolderOptionsRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
