...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetSuggestedUsersCountsResult :  IEquatable<GetSuggestedUsersCountsResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSuggestedUsersCountsResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetSuggestedUsersCountsResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSuggestedUsersCountsResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSuggestedUsersCountsResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetSuggestedUsersCountsResult);
        }

        /// <summary>
        /// Returns true if GetSuggestedUsersCountsResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetSuggestedUsersCountsResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSuggestedUsersCountsResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
