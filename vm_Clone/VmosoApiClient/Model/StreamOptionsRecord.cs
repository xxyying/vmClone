...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StreamOptionsRecord :  IEquatable<StreamOptionsRecord>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamOptionsRecord" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StreamOptionsRecord {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as StreamOptionsRecord);
        }

        /// <summary>
        /// Returns true if StreamOptionsRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of StreamOptionsRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StreamOptionsRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
