...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImportContactsResult :  IEquatable<ImportContactsResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportContactsResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ImportContactsResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportContactsResult" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets ListPageRecord
        /// </summary>
        [DataMember(Name="listPageRecord", EmitDefaultValue=false)]
        public ListPageRecord ListPageRecord { get; set; }
        /// <summary>
        /// Gets or Sets Hdr
        /// </summary>
        ...
        public List<ImportUserRecord> Users { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportContactsResult {\n");
            sb.Append("  ListPageRecord: ").Append(ListPageRecord).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ImportContactsResult);
        }

        /// <summary>
        /// Returns true if ImportContactsResult instances are equal
        /// </summary>
        /// <param name="other">Instance of ImportContactsResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportContactsResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.ListPageRecord == other.ListPageRecord ||
                    this.ListPageRecord != null &&
                    this.ListPageRecord.Equals(other.ListPageRecord)
                ) && 
                (
                    this.Hdr == other.Hdr ||
                    this.Hdr != null &&
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ListPageRecord != null)
                    hash = hash * 59 + this.ListPageRecord.GetHashCode();
                if (this.Hdr != null)
