...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ObjectV2Record :  IEquatable<ObjectV2Record>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectV2Record" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ObjectV2Record {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ObjectV2Record);
        }

        /// <summary>
        /// Returns true if ObjectV2Record instances are equal
        /// </summary>
        /// <param name="other">Instance of ObjectV2Record to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectV2Record other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
