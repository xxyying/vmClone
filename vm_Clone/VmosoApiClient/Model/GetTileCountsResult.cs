...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetTileCountsResult :  IEquatable<GetTileCountsResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTileCountsResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTileCountsResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTileCountsResult" /> class.
        /// </summary>
        ...
        public SparcCountRecord Counts { get; set; }
        /// <summary>
        /// Gets or Sets Hdr
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTileCountsResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetTileCountsResult);
        }

        /// <summary>
        /// Returns true if GetTileCountsResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetTileCountsResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTileCountsResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
