...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SetObjectTranslationsByFileResult :  IEquatable<SetObjectTranslationsByFileResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetObjectTranslationsByFileResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SetObjectTranslationsByFileResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SetObjectTranslationsByFileResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetObjectTranslationsByFileResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SetObjectTranslationsByFileResult);
        }

        /// <summary>
        /// Returns true if SetObjectTranslationsByFileResult instances are equal
        /// </summary>
        /// <param name="other">Instance of SetObjectTranslationsByFileResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetObjectTranslationsByFileResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
