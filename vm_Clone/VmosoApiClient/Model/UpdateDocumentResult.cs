...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateDocumentResult :  IEquatable<UpdateDocumentResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDocumentResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateDocumentResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDocumentResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateDocumentResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UpdateDocumentResult);
        }

        /// <summary>
        /// Returns true if UpdateDocumentResult instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateDocumentResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateDocumentResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
