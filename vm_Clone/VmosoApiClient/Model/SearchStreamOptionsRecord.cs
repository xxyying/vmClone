...
{
    /// <summary>
    /// SearchStreamOptionsRecord
    /// </summary>
    [DataContract]
    public partial class SearchStreamOptionsRecord : StreamOptionsRecord,  IEquatable<SearchStreamOptionsRecord>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchStreamOptionsRecord" /> class.
        /// </summary>
        ...
        /// <param name="MutualTypeFilter">MutualTypeFilter.</param>
        /// <param name="Formats">Formats.</param>
        /// <param name="PendingStateChangeFilter">Pending state change filter connected trusted.</param>
        /// <param name="FirstDegreeContactFilter">FirstDegreeContactFilter.</param>
        /// <param name="SimpleSearch">flag to determine if supporting more advanced search syntax like OR.</param>
        /// <param name="CompanyFilter">Filters by company.</param>
        /// <param name="IsDraft">Draft filter: true if is draft.</param>
        /// <param name="RuleGroup">Rule group.</param>
        /// <param name="ParentSpaceFilter">ParentSpaceFilter.</param>
        /// <param name="ExtraUserFields">extra user fields.</param>
        /// <param name="PresetRules">Retrieve preset rules.</param>
        /// <param name="ParticipantFilter">Participant filter.</param>
        /// <param name="MutualContactFilter">MutualContactFilter.</param>
        /// <param name="ContactFilter">Filters by ContactFilterRecord conditions.</param>
        /// <param name="UserGroup">User group filter... currently: creator to cc bcc scc.</param>
        /// <param name="RegistrationStateFilter">Registration state filter alien invited registered.</param>
        /// <param name="DueFilter">DueFilter.</param>
        /// <param name="NameFilter">Takes a letter of the alphabet and filters by names starting with the letter.</param>
        /// <param name="Format">return format.</param>
        /// <param name="Reshare">Flag to determine if search should only return objects (files) that user can reshare..</param>
        /// <param name="EmailDomainFilter">Filters by email domain.</param>
        /// <param name="UnsharedOnly">flag to determine if only want unshared space.</param>
        /// <param name="Q">key word (will be removed later, should use search_string).</param>
        /// <param name="Roothotspotkey">root hotspot key.</param>
        /// <param name="objectkey">object key.</param>
        /// <param name="RequestedStateChangeFilter">Requested state change filter connected trusted.</param>
        /// <param name="NaviKey">naviKey.</param>
        /// <param name="ContactTypeFilter">Contact type filter connected trusted engaged acquainted.</param>
        public SearchStreamOptionsRecord(string FtsField = null, List<string> TypeFilter = null, List<string> FolderRelationshipFilter = null, bool? MyHotspotsFilter = null, string Type = null, string SearchString = null, string Spacekey = null, string Mode = null, List<string> LifecycleFilter = null, string ObjectKey = null, List<string> RuleKey = null, string LfbTypeFilter = null, bool? MyFoldersFilter = null, bool? UseRelationshipFilter = null, bool? FilterDominantTime = null, List<ObjectTypeRecord> TypeFilters = null, List<string> UserFilter = null, string FolderRequestlistFilter = null, List<string> FlagFilter = null, List<string> SortAttr = null, string HighlightTag = null, string RelevanceFilter = null, List<string> LocaleFilter = null, string CardCreatorFilter = null, List<string> SubtypeFilter = null, string LfbZoneFilter = null, string Hotspot = null, List<string> UserStatusFilter = null, List<string> FolderFilter = null, string ListType = null, List<string> UpdaterKeyFilter = null, string RuleType = null, List<string> StatusFilter = null, string Hotspotkey = null, SubFilterRecord SubFilters = null, TimeRangeRecord UpdateTimeFilter = null, string CreatorFilter = null, string NamedFolderFilter = null, string ZoneFilter = null, List<string> CreatorKeyFilter = null, string UnreadFilter = null, string WallFilter = null, string FoldersForStream = null, string _Namespace = null, List<string> EnterpriseId = null, string SortDir = null, string FolderLevelFilter = null, string SearchField = null, PairContactFilterRecord MutualTypeFilter = null, AutocompleteFormatRecord Formats = null, List<string> PendingStateChangeFilter = null, PairContactFilterRecord FirstDegreeContactFilter = null, bool? SimpleSearch = null, List<string> CompanyFilter = null, bool? IsDraft = null, string RuleGroup = null, ParentSpaceFilterRecord ParentSpaceFilter = null, List<string> ExtraUserFields = null, bool? PresetRules = null, List<string> ParticipantFilter = null, PairContactFilterRecord MutualContactFilter = null, List<ContactFilterRecord> ContactFilter = null, List<string> UserGroup = null, List<string> RegistrationStateFilter = null, TimeRangeRecord DueFilter = null, string NameFilter = null, string Format = null, bool? Reshare = null, List<string> EmailDomainFilter = null, bool? UnsharedOnly = null, string Q = null, string Roothotspotkey = null, string objectkey = null, List<string> RequestedStateChangeFilter = null, string NaviKey = null, List<string> ContactTypeFilter = null)
        {
            ...
            this.MutualTypeFilter = MutualTypeFilter;
            this.Formats = Formats;
            this.PendingStateChangeFilter = PendingStateChangeFilter;
            this.FirstDegreeContactFilter = FirstDegreeContactFilter;
            this.SimpleSearch = SimpleSearch;
            this.CompanyFilter = CompanyFilter;
            this.IsDraft = IsDraft;
            this.RuleGroup = RuleGroup;
            this.ParentSpaceFilter = ParentSpaceFilter;
            this.ExtraUserFields = ExtraUserFields;
            this.PresetRules = PresetRules;
            this.ParticipantFilter = ParticipantFilter;
            this.MutualContactFilter = MutualContactFilter;
            this.ContactFilter = ContactFilter;
            this.UserGroup = UserGroup;
            this.RegistrationStateFilter = RegistrationStateFilter;
            this.DueFilter = DueFilter;
            this.NameFilter = NameFilter;
            this.Format = Format;
            this.Reshare = Reshare;
            this.EmailDomainFilter = EmailDomainFilter;
            this.UnsharedOnly = UnsharedOnly;
            this.Q = Q;
            this.Roothotspotkey = Roothotspotkey;
            this.objectkey = objectkey;
            this.RequestedStateChangeFilter = RequestedStateChangeFilter;
        ...
        /// <summary>
        /// Gets or Sets MutualTypeFilter
        /// </summary>
        [DataMember(Name="mutual_type_filter", EmitDefaultValue=false)]
        public PairContactFilterRecord MutualTypeFilter { get; set; }
        /// <summary>
        /// Gets or Sets Formats
        /// </summary>
        [DataMember(Name="formats", EmitDefaultValue=false)]
        public AutocompleteFormatRecord Formats { get; set; }
        /// <summary>
        /// Pending state change filter connected trusted
        /// </summary>
        /// <value>Pending state change filter connected trusted</value>
        [DataMember(Name="pending_state_change_filter", EmitDefaultValue=false)]
        public List<string> PendingStateChangeFilter { get; set; }
        /// <summary>
        /// Gets or Sets FirstDegreeContactFilter
        /// </summary>
        [DataMember(Name="first_degree_contact_filter", EmitDefaultValue=false)]
        public PairContactFilterRecord FirstDegreeContactFilter { get; set; }
        /// <summary>
        /// flag to determine if supporting more advanced search syntax like OR
        /// </summary>
        /// <value>flag to determine if supporting more advanced search syntax like OR</value>
        [DataMember(Name="simple_search", EmitDefaultValue=false)]
        public bool? SimpleSearch { get; set; }
        /// <summary>
        /// Filters by company
        /// </summary>
        /// <value>Filters by company</value>
        [DataMember(Name="company_filter", EmitDefaultValue=false)]
        public List<string> CompanyFilter { get; set; }
        /// <summary>
        /// Draft filter: true if is draft
        /// </summary>
        /// <value>Draft filter: true if is draft</value>
        ...
        /// <summary>
        /// Gets or Sets ParentSpaceFilter
        /// </summary>
        [DataMember(Name="parent_space_filter", EmitDefaultValue=false)]
        public ParentSpaceFilterRecord ParentSpaceFilter { get; set; }
        /// <summary>
        /// extra user fields
        /// </summary>
        /// <value>extra user fields</value>
        [DataMember(Name="extra_user_fields", EmitDefaultValue=false)]
        public List<string> ExtraUserFields { get; set; }
        /// <summary>
        ...
        [DataMember(Name="participant_filter", EmitDefaultValue=false)]
        public List<string> ParticipantFilter { get; set; }
        /// <summary>
        /// Gets or Sets MutualContactFilter
        /// </summary>
        [DataMember(Name="mutual_contact_filter", EmitDefaultValue=false)]
        public PairContactFilterRecord MutualContactFilter { get; set; }
        /// <summary>
        /// Filters by ContactFilterRecord conditions
        /// </summary>
        /// <value>Filters by ContactFilterRecord conditions</value>
        [DataMember(Name="contact_filter", EmitDefaultValue=false)]
        public List<ContactFilterRecord> ContactFilter { get; set; }
        /// <summary>
        /// User group filter... currently: creator to cc bcc scc
        /// </summary>
        /// <value>User group filter... currently: creator to cc bcc scc</value>
        [DataMember(Name="user_group", EmitDefaultValue=false)]
        public List<string> UserGroup { get; set; }
        /// <summary>
        /// Registration state filter alien invited registered
        /// </summary>
        /// <value>Registration state filter alien invited registered</value>
        [DataMember(Name="registration_state_filter", EmitDefaultValue=false)]
        public List<string> RegistrationStateFilter { get; set; }
        /// <summary>
        /// Gets or Sets DueFilter
        /// </summary>
        [DataMember(Name="due_filter", EmitDefaultValue=false)]
        public TimeRangeRecord DueFilter { get; set; }
        /// <summary>
        /// Takes a letter of the alphabet and filters by names starting with the letter
        /// </summary>
        /// <value>Takes a letter of the alphabet and filters by names starting with the letter</value>
        [DataMember(Name="name_filter", EmitDefaultValue=false)]
        ...
        /// <summary>
        /// Flag to determine if search should only return objects (files) that user can reshare.
        /// </summary>
        /// <value>Flag to determine if search should only return objects (files) that user can reshare.</value>
        [DataMember(Name="reshare", EmitDefaultValue=false)]
        public bool? Reshare { get; set; }
        /// <summary>
        /// Filters by email domain
        /// </summary>
        /// <value>Filters by email domain</value>
        [DataMember(Name="email_domain_filter", EmitDefaultValue=false)]
        public List<string> EmailDomainFilter { get; set; }
        /// <summary>
        /// flag to determine if only want unshared space
        /// </summary>
        /// <value>flag to determine if only want unshared space</value>
        [DataMember(Name="unshared_only", EmitDefaultValue=false)]
        public bool? UnsharedOnly { get; set; }
        /// <summary>
        /// key word (will be removed later, should use search_string)
        /// </summary>
        /// <value>key word (will be removed later, should use search_string)</value>
        [DataMember(Name="q", EmitDefaultValue=false)]
        public string Q { get; set; }
        /// <summary>
        /// root hotspot key
        /// </summary>
        /// <value>root hotspot key</value>
        ...
        public string objectkey { get; set; }
        /// <summary>
        /// Requested state change filter connected trusted
        /// </summary>
        /// <value>Requested state change filter connected trusted</value>
        [DataMember(Name="requested_state_change_filter", EmitDefaultValue=false)]
        public List<string> RequestedStateChangeFilter { get; set; }
        /// <summary>
        /// naviKey
        /// </summary>
        /// <value>naviKey</value>
        ...
        /// <summary>
        /// Contact type filter connected trusted engaged acquainted
        /// </summary>
        /// <value>Contact type filter connected trusted engaged acquainted</value>
        [DataMember(Name="contact_type_filter", EmitDefaultValue=false)]
        public List<string> ContactTypeFilter { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchStreamOptionsRecord {\n");
            ...
            sb.Append("  MutualTypeFilter: ").Append(MutualTypeFilter).Append("\n");
            sb.Append("  Formats: ").Append(Formats).Append("\n");
            sb.Append("  PendingStateChangeFilter: ").Append(PendingStateChangeFilter).Append("\n");
            sb.Append("  FirstDegreeContactFilter: ").Append(FirstDegreeContactFilter).Append("\n");
            sb.Append("  SimpleSearch: ").Append(SimpleSearch).Append("\n");
            sb.Append("  CompanyFilter: ").Append(CompanyFilter).Append("\n");
            sb.Append("  IsDraft: ").Append(IsDraft).Append("\n");
            sb.Append("  RuleGroup: ").Append(RuleGroup).Append("\n");
            sb.Append("  ParentSpaceFilter: ").Append(ParentSpaceFilter).Append("\n");
            sb.Append("  ExtraUserFields: ").Append(ExtraUserFields).Append("\n");
            sb.Append("  PresetRules: ").Append(PresetRules).Append("\n");
            sb.Append("  ParticipantFilter: ").Append(ParticipantFilter).Append("\n");
            sb.Append("  MutualContactFilter: ").Append(MutualContactFilter).Append("\n");
            sb.Append("  ContactFilter: ").Append(ContactFilter).Append("\n");
            sb.Append("  UserGroup: ").Append(UserGroup).Append("\n");
            sb.Append("  RegistrationStateFilter: ").Append(RegistrationStateFilter).Append("\n");
            sb.Append("  DueFilter: ").Append(DueFilter).Append("\n");
            sb.Append("  NameFilter: ").Append(NameFilter).Append("\n");
            sb.Append("  Format: ").Append(Format).Append("\n");
            sb.Append("  Reshare: ").Append(Reshare).Append("\n");
            sb.Append("  EmailDomainFilter: ").Append(EmailDomainFilter).Append("\n");
            sb.Append("  UnsharedOnly: ").Append(UnsharedOnly).Append("\n");
            sb.Append("  Q: ").Append(Q).Append("\n");
            sb.Append("  Roothotspotkey: ").Append(Roothotspotkey).Append("\n");
            sb.Append("  objectkey: ").Append(objectkey).Append("\n");
            sb.Append("  RequestedStateChangeFilter: ").Append(RequestedStateChangeFilter).Append("\n");
            sb.Append("  NaviKey: ").Append(NaviKey).Append("\n");
            sb.Append("  ContactTypeFilter: ").Append(ContactTypeFilter).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SearchStreamOptionsRecord);
        }

        /// <summary>
        /// Returns true if SearchStreamOptionsRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of SearchStreamOptionsRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchStreamOptionsRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.MutualTypeFilter == other.MutualTypeFilter ||
                    this.MutualTypeFilter != null &&
                    this.MutualTypeFilter.Equals(other.MutualTypeFilter)
                ) && 
                (
                ...
                (
                    this.PendingStateChangeFilter == other.PendingStateChangeFilter ||
                    this.PendingStateChangeFilter != null &&
                    this.PendingStateChangeFilter.SequenceEqual(other.PendingStateChangeFilter)
                ) && 
                (
                    this.FirstDegreeContactFilter == other.FirstDegreeContactFilter ||
                    this.FirstDegreeContactFilter != null &&
                    this.FirstDegreeContactFilter.Equals(other.FirstDegreeContactFilter)
                ) && 
                (
                ...
                (
                    this.CompanyFilter == other.CompanyFilter ||
                    this.CompanyFilter != null &&
                    this.CompanyFilter.SequenceEqual(other.CompanyFilter)
                ) && 
                (
                ...
                (
                    this.ParentSpaceFilter == other.ParentSpaceFilter ||
                    this.ParentSpaceFilter != null &&
                    this.ParentSpaceFilter.Equals(other.ParentSpaceFilter)
                ) && 
                (
                    this.ExtraUserFields == other.ExtraUserFields ||
                    this.ExtraUserFields != null &&
                    this.ExtraUserFields.SequenceEqual(other.ExtraUserFields)
                ) && 
                (
                ...
                (
                    this.MutualContactFilter == other.MutualContactFilter ||
                    this.MutualContactFilter != null &&
                    this.MutualContactFilter.Equals(other.MutualContactFilter)
                ) && 
                (
                    this.ContactFilter == other.ContactFilter ||
                    this.ContactFilter != null &&
                    this.ContactFilter.SequenceEqual(other.ContactFilter)
                ) && 
                (
                    this.UserGroup == other.UserGroup ||
                    this.UserGroup != null &&
                    this.UserGroup.SequenceEqual(other.UserGroup)
                ) && 
                (
                    this.RegistrationStateFilter == other.RegistrationStateFilter ||
                    this.RegistrationStateFilter != null &&
                    this.RegistrationStateFilter.SequenceEqual(other.RegistrationStateFilter)
                ) && 
                (
                    this.DueFilter == other.DueFilter ||
                    this.DueFilter != null &&
                    this.DueFilter.Equals(other.DueFilter)
                ) && 
                (
                ...
                (
                    this.Reshare == other.Reshare ||
                    this.Reshare != null &&
                    this.Reshare.Equals(other.Reshare)
                ) && 
                (
                    this.EmailDomainFilter == other.EmailDomainFilter ||
                    this.EmailDomainFilter != null &&
                    this.EmailDomainFilter.SequenceEqual(other.EmailDomainFilter)
                ) && 
                (
                    this.UnsharedOnly == other.UnsharedOnly ||
                    this.UnsharedOnly != null &&
                    this.UnsharedOnly.Equals(other.UnsharedOnly)
                ) && 
                (
                    this.Q == other.Q ||
                    this.Q != null &&
                ...
                (
                    this.RequestedStateChangeFilter == other.RequestedStateChangeFilter ||
                    this.RequestedStateChangeFilter != null &&
                    this.RequestedStateChangeFilter.SequenceEqual(other.RequestedStateChangeFilter)
                ) && 
                (
                ...
                (
                    this.ContactTypeFilter == other.ContactTypeFilter ||
                    this.ContactTypeFilter != null &&
                    this.ContactTypeFilter.SequenceEqual(other.ContactTypeFilter)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MutualTypeFilter != null)
                    hash = hash * 59 + this.MutualTypeFilter.GetHashCode();
                if (this.Formats != null)
                    hash = hash * 59 + this.Formats.GetHashCode();
                if (this.PendingStateChangeFilter != null)
                    hash = hash * 59 + this.PendingStateChangeFilter.GetHashCode();
                if (this.FirstDegreeContactFilter != null)
                    hash = hash * 59 + this.FirstDegreeContactFilter.GetHashCode();
                if (this.SimpleSearch != null)
                    hash = hash * 59 + this.SimpleSearch.GetHashCode();
                if (this.CompanyFilter != null)
                    hash = hash * 59 + this.CompanyFilter.GetHashCode();
                if (this.IsDraft != null)
                    hash = hash * 59 + this.IsDraft.GetHashCode();
                if (this.RuleGroup != null)
                    hash = hash * 59 + this.RuleGroup.GetHashCode();
                if (this.ParentSpaceFilter != null)
                    hash = hash * 59 + this.ParentSpaceFilter.GetHashCode();
                if (this.ExtraUserFields != null)
                    hash = hash * 59 + this.ExtraUserFields.GetHashCode();
                if (this.PresetRules != null)
                    hash = hash * 59 + this.PresetRules.GetHashCode();
                if (this.ParticipantFilter != null)
                    hash = hash * 59 + this.ParticipantFilter.GetHashCode();
                if (this.MutualContactFilter != null)
                    hash = hash * 59 + this.MutualContactFilter.GetHashCode();
                if (this.ContactFilter != null)
                    hash = hash * 59 + this.ContactFilter.GetHashCode();
                if (this.UserGroup != null)
                    hash = hash * 59 + this.UserGroup.GetHashCode();
                if (this.RegistrationStateFilter != null)
                    hash = hash * 59 + this.RegistrationStateFilter.GetHashCode();
                if (this.DueFilter != null)
                    hash = hash * 59 + this.DueFilter.GetHashCode();
                if (this.NameFilter != null)
                    hash = hash * 59 + this.NameFilter.GetHashCode();
                if (this.Format != null)
                    hash = hash * 59 + this.Format.GetHashCode();
                if (this.Reshare != null)
                    hash = hash * 59 + this.Reshare.GetHashCode();
                if (this.EmailDomainFilter != null)
                    hash = hash * 59 + this.EmailDomainFilter.GetHashCode();
                if (this.UnsharedOnly != null)
                    hash = hash * 59 + this.UnsharedOnly.GetHashCode();
                if (this.Q != null)
                ...
                if (this.objectkey != null)
                    hash = hash * 59 + this.objectkey.GetHashCode();
                if (this.RequestedStateChangeFilter != null)
                    hash = hash * 59 + this.RequestedStateChangeFilter.GetHashCode();
                if (this.NaviKey != null)
                    hash = hash * 59 + this.NaviKey.GetHashCode();
                if (this.ContactTypeFilter != null)
                    hash = hash * 59 + this.ContactTypeFilter.GetHashCode();
                return hash;
            }
        }
    }
