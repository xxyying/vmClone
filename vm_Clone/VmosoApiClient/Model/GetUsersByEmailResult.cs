...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetUsersByEmailResult :  IEquatable<GetUsersByEmailResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUsersByEmailResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetUsersByEmailResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUsersByEmailResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetUsersByEmailResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetUsersByEmailResult);
        }

        /// <summary>
        /// Returns true if GetUsersByEmailResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetUsersByEmailResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUsersByEmailResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
