...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskTemplateRecord : TaskRecord,  IEquatable<TaskTemplateRecord>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskTemplateRecord" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskTemplateRecord {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TaskTemplateRecord);
        }

        /// <summary>
        /// Returns true if TaskTemplateRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of TaskTemplateRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskTemplateRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
