...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetTokensResult :  IEquatable<GetTokensResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTokensResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTokensResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTokensResult" /> class.
        /// </summary>
        ...
        public List<PushTokenRecord> Token { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTokensResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetTokensResult);
        }

        /// <summary>
        /// Returns true if GetTokensResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetTokensResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTokensResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Token != null &&
                    this.Token.SequenceEqual(other.Token)
                );
        }
