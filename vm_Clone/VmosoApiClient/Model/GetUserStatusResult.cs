...
{
    /// <summary>
    /// 0 : success, 6 : input invalid
    /// </summary>
    [DataContract]
    public partial class GetUserStatusResult :  IEquatable<GetUserStatusResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUserStatusResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetUserStatusResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUserStatusResult" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value></value>
        [DataMember(Name="statusRecords", EmitDefaultValue=false)]
        public List<UserStatusRecord> StatusRecords { get; set; }
        /// <summary>
        /// Gets or Sets Hdr
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StatusRecords: ").Append(StatusRecords).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetUserStatusResult);
        }

        /// <summary>
        /// Returns true if GetUserStatusResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetUserStatusResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUserStatusResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.StatusRecords == other.StatusRecords ||
                    this.StatusRecords != null &&
                    this.StatusRecords.SequenceEqual(other.StatusRecords)
                ) && 
                (
                    this.Hdr == other.Hdr ||
                    this.Hdr != null &&
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StatusRecords != null)
                    hash = hash * 59 + this.StatusRecords.GetHashCode();
                if (this.Hdr != null)
