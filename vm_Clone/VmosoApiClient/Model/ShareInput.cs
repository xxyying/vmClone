...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShareInput :  IEquatable<ShareInput>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShareInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShareInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShareInput" /> class.
        /// </summary>
        ...
        public ShareInput(SpaceShareOptionsRecord Options = null, List<string> Destinationkeys = null, List<string> Itemkeys = null)
        {
            // to ensure "Options" is required (not null)
            if (Options == null)
            {
                throw new InvalidDataException("Options is a required property for ShareInput and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ShareInput);
        }

        /// <summary>
        /// Returns true if ShareInput instances are equal
        /// </summary>
        /// <param name="other">Instance of ShareInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShareInput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
