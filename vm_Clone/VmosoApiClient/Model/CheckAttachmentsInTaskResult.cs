...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CheckAttachmentsInTaskResult :  IEquatable<CheckAttachmentsInTaskResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckAttachmentsInTaskResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CheckAttachmentsInTaskResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckAttachmentsInTaskResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckAttachmentsInTaskResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CheckAttachmentsInTaskResult);
        }

        /// <summary>
        /// Returns true if CheckAttachmentsInTaskResult instances are equal
        /// </summary>
        /// <param name="other">Instance of CheckAttachmentsInTaskResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckAttachmentsInTaskResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
