...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetUserByEmailResult :  IEquatable<GetUserByEmailResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUserByEmailResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetUserByEmailResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUserByEmailResult" /> class.
        /// </summary>
        /// <param name="DisplayRecord">DisplayRecord (required).</param>
        /// <param name="Hdr">Hdr (required).</param>
        public GetUserByEmailResult(DisplayRecord DisplayRecord = null, ResponseHeaderRecord Hdr = null)
        {
            // to ensure "DisplayRecord" is required (not null)
            if (DisplayRecord == null)
            {
                throw new InvalidDataException("DisplayRecord is a required property for GetUserByEmailResult and cannot be null");
            }
            else
            {
            ...
            if (Hdr == null)
            {
                throw new InvalidDataException("Hdr is a required property for GetUserByEmailResult and cannot be null");
            }
            else
            {
                this.Hdr = Hdr;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetUserByEmailResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetUserByEmailResult);
        }

        /// <summary>
        /// Returns true if GetUserByEmailResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetUserByEmailResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUserByEmailResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
