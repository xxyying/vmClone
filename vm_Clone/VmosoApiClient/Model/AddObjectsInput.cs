...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddObjectsInput :  IEquatable<AddObjectsInput>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddObjectsInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddObjectsInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddObjectsInput" /> class.
        /// </summary>
        ...
        public AddObjectsInput(string SpaceId = null, List<string> ItemKeys = null, List<string> ExtraFolderKeys = null)
        {
            // to ensure "SpaceId" is required (not null)
            if (SpaceId == null)
            {
                throw new InvalidDataException("SpaceId is a required property for AddObjectsInput and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddObjectsInput {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AddObjectsInput);
        }

        /// <summary>
        /// Returns true if AddObjectsInput instances are equal
        /// </summary>
        /// <param name="other">Instance of AddObjectsInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddObjectsInput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
