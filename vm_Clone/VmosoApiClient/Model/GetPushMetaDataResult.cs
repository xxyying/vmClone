...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetPushMetaDataResult :  IEquatable<GetPushMetaDataResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPushMetaDataResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPushMetaDataResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPushMetaDataResult" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets PushMetaData
        /// </summary>
        [DataMember(Name="pushMetaData", EmitDefaultValue=false)]
        public RuleMetaDataRecord PushMetaData { get; set; }
        /// <summary>
        /// Gets or Sets Hdr
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPushMetaDataResult {\n");
            sb.Append("  PushMetaData: ").Append(PushMetaData).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetPushMetaDataResult);
        }

        /// <summary>
        /// Returns true if GetPushMetaDataResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetPushMetaDataResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPushMetaDataResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.PushMetaData == other.PushMetaData ||
                    this.PushMetaData != null &&
                    this.PushMetaData.Equals(other.PushMetaData)
                ) && 
                (
                    this.Hdr == other.Hdr ||
                    this.Hdr != null &&
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PushMetaData != null)
                    hash = hash * 59 + this.PushMetaData.GetHashCode();
                if (this.Hdr != null)
