...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetSchemeResult :  IEquatable<GetSchemeResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSchemeResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetSchemeResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSchemeResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSchemeResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetSchemeResult);
        }

        /// <summary>
        /// Returns true if GetSchemeResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetSchemeResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSchemeResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
