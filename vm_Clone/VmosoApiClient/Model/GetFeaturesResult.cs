...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetFeaturesResult :  IEquatable<GetFeaturesResult>
    {
        /// <summary>
        ...
        public GetFeaturesResult(FeaturesRecord Features = null, ResponseHeaderRecord Hdr = null)
        {
            ...
            if (Hdr == null)
            {
                throw new InvalidDataException("Hdr is a required property for GetFeaturesResult and cannot be null");
            }
            else
            {
                this.Hdr = Hdr;
        ...
        public FeaturesRecord Features { get; set; }
        /// <summary>
        /// Gets or Sets Hdr
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetFeaturesResult);
        }

        /// <summary>
        /// Returns true if GetFeaturesResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetFeaturesResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetFeaturesResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
