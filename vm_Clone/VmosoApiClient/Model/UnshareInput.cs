...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UnshareInput :  IEquatable<UnshareInput>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnshareInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnshareInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnshareInput" /> class.
        /// </summary>
        ...
        public UnshareInput(SpaceShareOptionsRecord Options = null, List<string> Destinationkeys = null, List<string> Itemkeys = null)
        {
            // to ensure "Options" is required (not null)
            if (Options == null)
            {
                throw new InvalidDataException("Options is a required property for UnshareInput and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UnshareInput);
        }

        /// <summary>
        /// Returns true if UnshareInput instances are equal
        /// </summary>
        /// <param name="other">Instance of UnshareInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnshareInput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
