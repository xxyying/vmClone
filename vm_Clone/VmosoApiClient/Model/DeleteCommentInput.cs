...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteCommentInput :  IEquatable<DeleteCommentInput>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteCommentInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteCommentInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteCommentInput" /> class.
        /// </summary>
        ...
        public DeleteCommentInput(string CommentListKey = null, string ContentKey = null, int? CommentID = null)
        {
            // to ensure "CommentListKey" is required (not null)
            if (CommentListKey == null)
            {
                throw new InvalidDataException("CommentListKey is a required property for DeleteCommentInput and cannot be null");
            }
            else
            {
            ...
            if (ContentKey == null)
            {
                throw new InvalidDataException("ContentKey is a required property for DeleteCommentInput and cannot be null");
            }
            else
            {
            ...
            if (CommentID == null)
            {
                throw new InvalidDataException("CommentID is a required property for DeleteCommentInput and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DeleteCommentInput);
        }

        /// <summary>
        /// Returns true if DeleteCommentInput instances are equal
        /// </summary>
        /// <param name="other">Instance of DeleteCommentInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteCommentInput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
