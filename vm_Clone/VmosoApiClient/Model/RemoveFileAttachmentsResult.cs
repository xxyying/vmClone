...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemoveFileAttachmentsResult :  IEquatable<RemoveFileAttachmentsResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveFileAttachmentsResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RemoveFileAttachmentsResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveFileAttachmentsResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemoveFileAttachmentsResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RemoveFileAttachmentsResult);
        }

        /// <summary>
        /// Returns true if RemoveFileAttachmentsResult instances are equal
        /// </summary>
        /// <param name="other">Instance of RemoveFileAttachmentsResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveFileAttachmentsResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
