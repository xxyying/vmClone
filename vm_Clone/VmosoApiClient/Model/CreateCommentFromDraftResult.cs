...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateCommentFromDraftResult :  IEquatable<CreateCommentFromDraftResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCommentFromDraftResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCommentFromDraftResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCommentFromDraftResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateCommentFromDraftResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateCommentFromDraftResult);
        }

        /// <summary>
        /// Returns true if CreateCommentFromDraftResult instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateCommentFromDraftResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCommentFromDraftResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
