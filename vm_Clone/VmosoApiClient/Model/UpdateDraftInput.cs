...
namespace VmosoApiClient.Model
{
    ...
    public partial class UpdateDraftInput :  IEquatable<UpdateDraftInput>
    {
        ...
        public UpdateDraftInput(TaskDraftRecord Taskrecord = null)
        {
            // to ensure "Taskrecord" is required (not null)
            if (Taskrecord == null)
            {
                throw new InvalidDataException("Taskrecord is a required property for UpdateDraftInput and cannot be null");
            }
            else
            {
