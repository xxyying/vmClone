...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetAvailableActionsResult :  IEquatable<GetAvailableActionsResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvailableActionsResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAvailableActionsResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvailableActionsResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAvailableActionsResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetAvailableActionsResult);
        }

        /// <summary>
        /// Returns true if GetAvailableActionsResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetAvailableActionsResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAvailableActionsResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
