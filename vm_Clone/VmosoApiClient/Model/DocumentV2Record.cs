...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentV2Record : RateableObjectV2Record,  IEquatable<DocumentV2Record>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentV2Record" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentV2Record {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DocumentV2Record);
        }

        /// <summary>
        /// Returns true if DocumentV2Record instances are equal
        /// </summary>
        /// <param name="other">Instance of DocumentV2Record to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentV2Record other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
