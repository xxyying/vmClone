...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetPayloadResult :  IEquatable<GetPayloadResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPayloadResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPayloadResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPayloadResult" /> class.
        /// </summary>
        ...
        public WorkflowDataRecord Payload { get; set; }
        /// <summary>
        /// Gets or Sets Hdr
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPayloadResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetPayloadResult);
        }

        /// <summary>
        /// Returns true if GetPayloadResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetPayloadResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPayloadResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
