...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateRuleResult :  IEquatable<CreateRuleResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRuleResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateRuleResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRuleResult" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets SavedRule
        /// </summary>
        [DataMember(Name="savedRule", EmitDefaultValue=false)]
        public RuleRecord SavedRule { get; set; }
        /// <summary>
        /// Gets or Sets Hdr
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SavedRule: ").Append(SavedRule).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateRuleResult);
        }

        /// <summary>
        /// Returns true if CreateRuleResult instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateRuleResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateRuleResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.SavedRule == other.SavedRule ||
                    this.SavedRule != null &&
                    this.SavedRule.Equals(other.SavedRule)
                ) && 
                (
                    this.Hdr == other.Hdr ||
                    this.Hdr != null &&
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SavedRule != null)
                    hash = hash * 59 + this.SavedRule.GetHashCode();
                if (this.Hdr != null)
