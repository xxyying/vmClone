...
{
    /// <summary>
    /// FolderMultishareInput
    /// </summary>
    [DataContract]
    public partial class FolderMultishareInput :  IEquatable<FolderMultishareInput>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderMultishareInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FolderMultishareInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderMultishareInput" /> class.
        /// </summary>
        ...
        public FolderMultishareInput(SpaceShareOptionsRecord Options = null, List<string> Destinationkeys = null, List<string> Itemkeys = null)
        {
            // to ensure "Options" is required (not null)
            if (Options == null)
            {
                throw new InvalidDataException("Options is a required property for FolderMultishareInput and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FolderMultishareInput {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FolderMultishareInput);
        }

        /// <summary>
        /// Returns true if FolderMultishareInput instances are equal
        /// </summary>
        /// <param name="other">Instance of FolderMultishareInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FolderMultishareInput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
