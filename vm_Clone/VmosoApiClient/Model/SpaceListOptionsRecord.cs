...
{
    /// <summary>
    /// SpaceListOptionsRecord
    /// </summary>
    [DataContract]
    public partial class SpaceListOptionsRecord : ListOptionsRecord,  IEquatable<SpaceListOptionsRecord>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SpaceListOptionsRecord {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SpaceListOptionsRecord);
        }

        /// <summary>
        /// Returns true if SpaceListOptionsRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of SpaceListOptionsRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpaceListOptionsRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
