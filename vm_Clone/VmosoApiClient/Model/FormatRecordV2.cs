...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FormatRecordV2 :  IEquatable<FormatRecordV2>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormatRecordV2" /> class.
        /// </summary>
        /// <param name="ObjectFormat">Record return format: s m l.</param>
        public FormatRecordV2(string ObjectFormat = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FormatRecordV2 {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FormatRecordV2);
        }

        /// <summary>
        /// Returns true if FormatRecordV2 instances are equal
        /// </summary>
        /// <param name="other">Instance of FormatRecordV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FormatRecordV2 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
