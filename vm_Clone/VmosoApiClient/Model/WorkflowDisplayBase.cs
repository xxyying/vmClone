...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WorkflowDisplayBase : DisplayRecord,  IEquatable<WorkflowDisplayBase>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkflowDisplayBase {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WorkflowDisplayBase);
        }

        /// <summary>
        /// Returns true if WorkflowDisplayBase instances are equal
        /// </summary>
        /// <param name="other">Instance of WorkflowDisplayBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkflowDisplayBase other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
