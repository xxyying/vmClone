...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListPayloadResult :  IEquatable<ListPayloadResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListPayloadResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListPayloadResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListPayloadResult" /> class.
        /// </summary>
        ...
        public List<WorkflowPayloadItemRecord> Payloads { get; set; }
        /// <summary>
        /// Gets or Sets Hdr
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListPayloadResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ListPayloadResult);
        }

        /// <summary>
        /// Returns true if ListPayloadResult instances are equal
        /// </summary>
        /// <param name="other">Instance of ListPayloadResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListPayloadResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
