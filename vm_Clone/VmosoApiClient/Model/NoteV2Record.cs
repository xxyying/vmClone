...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NoteV2Record : DocumentV2Record,  IEquatable<NoteV2Record>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NoteV2Record);
        }

        /// <summary>
        /// Returns true if NoteV2Record instances are equal
        /// </summary>
        /// <param name="other">Instance of NoteV2Record to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NoteV2Record other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
