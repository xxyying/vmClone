...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WidgetOptionsRecord : StreamOptionsRecord,  IEquatable<WidgetOptionsRecord>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WidgetOptionsRecord" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WidgetOptionsRecord {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WidgetOptionsRecord);
        }

        /// <summary>
        /// Returns true if WidgetOptionsRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of WidgetOptionsRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WidgetOptionsRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
