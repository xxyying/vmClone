...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BasicRecord :  IEquatable<BasicRecord>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BasicRecord" /> class.
        /// </summary>
        ...
        public BasicRecord(string Name = null, string NaviKey = null, string Key = null)
        {
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BasicRecord);
        }

        /// <summary>
        /// Returns true if BasicRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of BasicRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasicRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
