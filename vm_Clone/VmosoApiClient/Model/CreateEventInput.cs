...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateEventInput :  IEquatable<CreateEventInput>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEventInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateEventInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEventInput" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateEventInput {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateEventInput);
        }

        /// <summary>
        /// Returns true if CreateEventInput instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateEventInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateEventInput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
