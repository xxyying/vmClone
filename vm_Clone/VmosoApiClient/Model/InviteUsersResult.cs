...
{
    /// <summary>
    /// 0 : success, 6 : missing input
    /// </summary>
    [DataContract]
    public partial class InviteUsersResult :  IEquatable<InviteUsersResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InviteUsersResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InviteUsersResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InviteUsersResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InviteUsersResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InviteUsersResult);
        }

        /// <summary>
        /// Returns true if InviteUsersResult instances are equal
        /// </summary>
        /// <param name="other">Instance of InviteUsersResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InviteUsersResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
