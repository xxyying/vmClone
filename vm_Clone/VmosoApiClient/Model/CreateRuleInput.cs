...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateRuleInput :  IEquatable<CreateRuleInput>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRuleInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateRuleInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRuleInput" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateRuleInput);
        }

        /// <summary>
        /// Returns true if CreateRuleInput instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateRuleInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateRuleInput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
