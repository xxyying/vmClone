...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BenchmarkResult :  IEquatable<BenchmarkResult>
    {
        /// <summary>
        ...
        public BenchmarkResult(string Bytes = null, ResponseHeaderRecord Hdr = null)
        {
            // to ensure "Bytes" is required (not null)
            if (Bytes == null)
            {
                throw new InvalidDataException("Bytes is a required property for BenchmarkResult and cannot be null");
            }
            else
            {
                this.Bytes = Bytes;
            ...
            if (Hdr == null)
            {
                throw new InvalidDataException("Hdr is a required property for BenchmarkResult and cannot be null");
            }
            else
            {
                this.Hdr = Hdr;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BenchmarkResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BenchmarkResult);
        }

        /// <summary>
        /// Returns true if BenchmarkResult instances are equal
        /// </summary>
        /// <param name="other">Instance of BenchmarkResult to be compared</param>
        /// <returns>Boolean</returns>
