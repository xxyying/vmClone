...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdatePostResult :  IEquatable<UpdatePostResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePostResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdatePostResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePostResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdatePostResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UpdatePostResult);
        }

        /// <summary>
        /// Returns true if UpdatePostResult instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdatePostResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePostResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
