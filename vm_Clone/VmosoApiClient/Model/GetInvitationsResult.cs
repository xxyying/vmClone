...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetInvitationsResult :  IEquatable<GetInvitationsResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetInvitationsResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetInvitationsResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetInvitationsResult" /> class.
        /// </summary>
        ...
        public List<InvitationRecordV2> Result { get; set; }
        /// <summary>
        /// Gets or Sets Pager
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetInvitationsResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetInvitationsResult);
        }

        /// <summary>
        /// Returns true if GetInvitationsResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetInvitationsResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetInvitationsResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
