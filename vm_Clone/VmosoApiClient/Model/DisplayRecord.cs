...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DisplayRecord :  IEquatable<DisplayRecord>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DisplayRecord" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DisplayRecord);
        }

        /// <summary>
        /// Returns true if DisplayRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of DisplayRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DisplayRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
