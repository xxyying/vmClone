...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetDownloadTokenResult :  IEquatable<GetDownloadTokenResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDownloadTokenResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetDownloadTokenResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDownloadTokenResult" /> class.
        /// </summary>
        ...
        public RemoteFileDownloadRecord Result { get; set; }
        /// <summary>
        /// Gets or Sets Hdr
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetDownloadTokenResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetDownloadTokenResult);
        }

        /// <summary>
        /// Returns true if GetDownloadTokenResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetDownloadTokenResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDownloadTokenResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
