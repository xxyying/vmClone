...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetContentMarksResult :  IEquatable<GetContentMarksResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetContentMarksResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetContentMarksResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetContentMarksResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetContentMarksResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetContentMarksResult);
        }

        /// <summary>
        /// Returns true if GetContentMarksResult instances are equal
        /// </summary>
        /// <param name="other">Instance of GetContentMarksResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetContentMarksResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Mark != null &&
                    this.Mark.SequenceEqual(other.Mark)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Mark != null)
                    hash = hash * 59 + this.Mark.GetHashCode();
                return hash;
            }
        }
    }
