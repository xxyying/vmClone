...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LogoutResult :  IEquatable<LogoutResult>
    {
        /// <summary>
        ...
        public LogoutResult(ResponseHeaderRecord Hdr = null)
        {
            // to ensure "Hdr" is required (not null)
            if (Hdr == null)
            {
                throw new InvalidDataException("Hdr is a required property for LogoutResult and cannot be null");
            }
            else
            {
                this.Hdr = Hdr;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LogoutResult);
        }

        /// <summary>
        /// Returns true if LogoutResult instances are equal
        /// </summary>
        /// <param name="other">Instance of LogoutResult to be compared</param>
        /// <returns>Boolean</returns>
