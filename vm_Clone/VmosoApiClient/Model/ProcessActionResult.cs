...
namespace VmosoApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProcessActionResult :  IEquatable<ProcessActionResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessActionResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProcessActionResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessActionResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProcessActionResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProcessActionResult);
        }

        /// <summary>
        /// Returns true if ProcessActionResult instances are equal
        /// </summary>
        /// <param name="other">Instance of ProcessActionResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessActionResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
