...
namespace vm_Clone
{
    class ClipboardHtmlFragment {
        ...
        static public ClipboardHtmlFragment FromClipboard()
        {

            string rawClipboardText = Clipboard.GetText(TextDataFormat.Html);
            ClipboardHtmlFragment h = new ClipboardHtmlFragment(rawClipboardText);
            return h;
        }


        public ClipboardHtmlFragment(string rawClipboardText)
        {
            int startHMTL = 0;
            int endHTML = 0;
            int startFragment = 0;
